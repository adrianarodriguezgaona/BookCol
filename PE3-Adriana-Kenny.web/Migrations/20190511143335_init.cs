    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "Suite met Uitzicht op Zee" },
                    { 2L, "Suite" },
                    { 3L, "Tweepersoonskamer" },
                    { 4L, "Driepersoonskamer" },
                    { 5L, "Tweepersoonskamer met 2 aparte bedden" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 20L, "Via san luis, 880001 San Andrés.", 4L, "Hostal Rohomar biedt gratis WiFi en uitzicht op zee in San Andrés. Het pension ligt op ongeveer 2,6 km van de baai van San Andres en op 3,5 km van North End. Lokale bezienswaardigheden zoals Spratt Bight en The Hill zijn bereikbaar binnen respectievelijk 3,7 km en 1,9 km.", "Hostal Rohomar", 5, "HostalRohomar.jpg", 3 },
                    { 19L, "Via San Luis, Antes de Rocky Cay Bay,  San Andrés.", 4L, "San Luis Place By El Dorado ligt in San Andrés, in de omgeving van de eilanden San Andres en Providencia, op nog geen 3,5 km van San Andrés-baai, en beschikt over een zonneterras en een eigen strand.", "San Luis Place By El Dorado", 5, "ElDorado.jpg", 5 },
                    { 18L, "Vía a San Luis # 43-39, San Andrés.", 4L, "Hotel Cocoplum Beach ligt aan het Cocoplum - strand, een van de mooiste stranden van San Andrés. Het biedt een zwembad, een spa en een restaurant met uitzicht op zee. Er is gratis WiFi beschikbaar in de gemeenschappelijke ruimtes en het hotel serveert ontbijt.", "Hotel Cocoplum Beach", 5, "CocoplumBeach.jpg", 4 },
                    { 17L, "Calle 3 18 - 71 , San Andrés.", 4L, "Deze elegante villa in mediterrane stijl heeft een buitenzwembad.U kunt er verblijven in kamers met airconditioning en gratis WiFi. Er is ook gratis privéparkeergelegenheid beschikbaar.", "Le Castel Blanc Hotel Boutique", 5, "LeCastelBlanc.jpg", 5 },
                    { 16L, "Av. 20 de Julio Nº 3A - 122, San Andrés.", 4L, "San Andrés Hostel heeft kamers met airconditioning.Het ligt op slechts 5 minuten lopen van het strand en de zee van 7 kleuren.Er is een discobar bij de accommodatie en er zijn duiklessen beschikbaar. ", "Viajero San Andres Hostel", 5, "ViajeroSanandresHostel.jpg ", 4 },
                    { 15L, "CR 69 46B 34, Laureles, Medellín.", 3L, "Mooie, schone kamers met een moderne badkamer. Op loopafstand van het metrostation en om de hoek van een gezellige uitgaansstraat in Medellin met leuke restaurants e.d.waar weinig toeristen komen en je dus meer tussen de locals zit. Top locatie!", "HOTEL MED 70", 5, "Med70.jpg", 4 },
                    { 14L, "Carrera 32d # 9-17, El Poblado, Medellín.", 3L, "Selina Medellin ligt in Medellín en biedt een terras, een gemeenschappelijke lounge, een restaurant, een 24 - uursreceptie, een gemeenschappelijke keuken en gratis WiFi. Voor een drankje kunt u terecht bij de bar.", "Selina Medellin", 5, "SelinaMedellin.jpg", 3 },
                    ...
                    { 13L, "3324 Carrera 65, Laureles, Medellín", 3L, "Hotel Medellin 33 ligt op 2,9 km van Pueblito Paisa, in Medellín.Het biedt een aantal voorzieningen, waaronder een buitenzwembad, een fitnesscentrum en een terras.Tot de faciliteiten van deze accommodatie behoren een restaurant, een 24 - uursreceptie, een gemeenschappelijke lounge en gratis WiFi. De accommodatie beschikt over een hot tub, entertainmentpersoneel en roomservice.", "Hotel Medellin 33", 5, "Medellin33.jpg", 3 },
                    { 11L, "Carrera 42 A No. 1 - 15, El Poblado, Medellín", 3L, "San Fernando Plaza beschikt over een verwarmd buitenzwembad, een spa en een fitnesscentrum.Het biedt luxe accommodatie in El Poblado, de exclusieve financiële en commerciële wijk van Medellin.Het hotel heeft ook een restaurant en een bar.", "Hotel San Fernando Plaza", 5, "SanFernandoPlaza.jpg", 5 },
                    ...
                    { 12L, "Carrera 45 # 49-35, La Candelaria, Medellín.", 3L, "Hotel Suite 45 ligt in Medellin, op slechts 1 km van het metrostation Parque Berrio en biedt kamers met gratis WiFi en kabel-tv. Bij de accommodatie is gratis parkeergelegenheid beschikbaar. Het centrale plein en het Botero-plein liggen op 1 km afstand.", "Hotel Suite 45", 5, "Suite45.jpg", 3 },
